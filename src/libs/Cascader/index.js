...
var Cascader = React.createClass({
    ...
    provinceOption: function(provinceCode,cityCode,countyCode){
        ...
        this.state.data && this.state.data.map(function(array, index){
            ...
            if (on) {
                strHtml.push(<li key={index} data-index={index} data-code={array.code} data-value={array.value} onClick={that.provinceChange}>{array.value}</li>);
            }else{
                strHtml.push(<li key={index} data-index={index} data-code={array.code} data-value={array.value} data-disabled={true} style={{"cursor":"not-allowed"}} onClick={that.provinceChange}>{array.value}</li>);
            } 
        });
        return strHtml;
    },
        ...
        if(provinceIndex == -1){
            ...
            this.state.data[provinceIndex].children && this.state.data[provinceIndex].children.map(function(array, index){
               if(cityCode && cityCode == array.code){
                ...
                if (on) {
                    strHtml.push(<li key={index} data-index={index} data-code={array.code} data-value={array.value} onClick={that.cityChange}>{array.value}</li>);
                }else{
                    strHtml.push(<li key={index} data-index={index} data-code={array.code} data-value={array.value} data-disabled={true} style={{"cursor":"not-allowed"}} onClick={that.cityChange}>{array.value}</li>);
                } 
            });
            return strHtml;
        }
    ...
    countyOption: function(countyCode){
        ...
        if(cityIndex == -1){    
            ...
            this.state.data[provinceIndex].children[cityIndex].children && this.state.data[provinceIndex].children[cityIndex].children.map(function(array, index){
                ...
                if (on) {
                    strHtml.push(<li key={index} data-index={index} data-code={array.code} data-value={array.value} onClick={that.countyChange}>{array.value}</li>);
                }else{
                    strHtml.push(<li key={index} data-index={index} data-code={array.code} data-value={array.value} data-disabled={true} style={{"cursor":"not-allowed"}} onClick={that.countyChange}>{array.value}</li>);
                } 
            });
            return strHtml;
        }
    ...
    render: function(){
        ...
        return (
                <div id={this.props.id} 
                    ...
                    ref="cascader" >
                    <div className="ucs-cascader-wrap">
                        <div 
                            className = {
                                classnames( 
                                        "ucs-cascader-select",
                            ...
                            <div className= "ucs-cascader-input" 
                                data-index="1"
                                ref="province"
                        ...
                        <input type="hidden" className={this.state.provinceIndex} name={this.props.name.provinceName} value={this.state.jsonValue.provinceCode} ref="selectValue1"/>
                    </div>
                    <div className="title">{this.props.title.province}</div>
                    ...
                    <div className="ucs-cascader-wrap">
                        ...
                        <input type="hidden" className={this.state.cityIndex} name={this.props.name.cityName} value={this.state.jsonValue.cityCode} ref="selectValue2"/>
                    </div>
                    <div className="title">{this.props.title.city}</div>

                    <div className="ucs-cascader-wrap" style={{display:this.display}}>
                        <div 
                            className= {
                                        classnames( 
                                            "ucs-cascader-select",
                        ...
                        <input type="hidden" name={this.props.name.countyName} value={this.state.jsonValue.countyCode} ref="selectValue3"/>
                    </div>
                    <div className="title" style={{display:this.display}} >{this.props.title.county}</div>
                </div>
        );
    }
});
